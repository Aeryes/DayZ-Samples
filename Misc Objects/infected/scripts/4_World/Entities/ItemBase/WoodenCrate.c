modded class PlayerBase
{
    override void Init()
    {
        ...
        GetDayZPlayerType().AddItemInHandsProfileIK("WoodenCrateModded", "dz/anims/workspaces/player/player_main/player_main_heavy.asi", heavyItemBehaviour, "dz/anims/anm/player/ik/heavy/wooden_log.anm");
    }
}

class WoodenCrateModded extends ItemBase {

    void WoodenCrateModded()
    {
    }
