modded class PlayerBase
{
    override void Init()
    {
        ...
        GetDayZPlayerType().AddItemInHandsProfileIK("Locked_Safe", "dz/anims/workspaces/player/player_main/player_main_heavy.asi", heavyItemBehaviour, "dz/anims/anm/player/ik/heavy/wooden_log.anm");
    }
}

class Locked_Safe extends ItemBase {
