class ActionDismantleBonfireBaseCB : ActionContinuousBaseCB
{
...
class ActionDismantleBonfireBase: ActionContinuousBase
{
	void ActionDismantleBonfireBase()
	{
		m_CallbackClass = ActionDismantleBonfireBaseCB;
	...
	override void OnFinishProgressServer( ActionData action_data ) 
	{
		...
		{	
			...
			ItemBase Re_Kit = ItemBase.Cast( GetGame().CreateObject("BonfireKit", pos) );
				// Result Class
		}
