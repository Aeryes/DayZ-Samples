...
class HordeSettingsScript
{
    ...
    void HordeDefaultSettings()
    {
        ...
        /////////////////////////////
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2924, 12358, "Topolniki", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12100, 13750, "Cernaya Polana", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9520, 8758, "Gorka", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(5950, 10300, "Grishino", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2250, 11050, "Vavilovo", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2750, 9950, "Lopatino", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3786, 8923, "Vybor", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(5350, 8600, "Kabanino", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6250, 7830, "Stary Sobor", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7140, 7633, "Novy Sobor", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10700, 8050, "Polana", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10100, 5450, "Staroye", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12050, 3550, "Kamyshovo", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13600, 3000, "Skalisty Island", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(7550, 5100, "Moglievka", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4500, 2450, "Balota", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1700, 3850, "Pavlovo", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4400, 4650, "Kozlovka", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(5850, 4750, "Nadezhdino", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4500, 6400, "Pogorevka", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3050, 7900, "Pustoshka", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4950, 15050, "Stary Yar", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6759, 14446, "Kamensk", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13504, 14109, "Turovo", "town"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11079, 12231, "Krasnostav", "town"));

        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6506, 14992, "Krasnoe", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1440, 12018, "Sinistok", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(6250, 12700, "Ratnoe", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9500, 13750, "Svergino", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(10400, 9850, "Dubrovka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(8400, 6650, "Guglovo", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9650, 6550, "Shakhovka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12150, 7250, "Orlovets", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12950, 8050, "Nizhnoye", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11300, 6550, "Dolina", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3650, 2450, "Komarovo", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1900, 2250, "Kamenka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1963, 7293, "Myshkino", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1539, 8971, "Bogatyrka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(1159, 9956, "Zabolotye", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3472, 14859, "Tisy", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9372, 14508, "Nagornoe", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13019, 15028, "Dobroe", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(14091, 14931, "Belaya Polana", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(15085, 13877, "Berezhki", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12709, 14672, "Karmanovka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13404, 12900, "Olsha", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12362, 10917, "Chelm", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9973, 10323, "Vyshnaya Dubrovka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(13400, 6250, "Solnechiy", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(11342, 5439, "Msta", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(12772, 4394, "Tulga", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(9101, 3961, "Pusta", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3314, 4005, "Bor", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(3359, 4877, "Drozhino", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(437, 5218, "Zvir", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(2609, 6387, "Sosnovka", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(5009, 5638, "Pulkovo", "village"));
        HordeLocationFuncsArray.Insert(new HordeLocationFuncs(4813, 6738, "Rogovo", "village"));
